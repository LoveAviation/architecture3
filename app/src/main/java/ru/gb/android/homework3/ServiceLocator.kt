...
import ru.gb.android.homework3.data.product.ProductLocalDataSource
...
import ru.gb.android.homework3.data.promo.PromoLocalDataSource
import ru.gb.android.homework3.data.promo.PromoRemoteDataSource
    ...
    private fun providePromoRepository(): PromoRepository {
        ...
        return local ?: run {
            val newPromoRepository = PromoRepository(
                ...
                dispatcher = provideCoroutineDispatcher(),
            )
